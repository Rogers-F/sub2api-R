...
func init() {
	...
	groupDescClaudeToolArgumentsRepairEnabled := groupFields[18].Descriptor()
	...
	// groupDescBedrockRequestCompatEnabled is the schema descriptor for bedrock_request_compat_enabled field.
	groupDescBedrockRequestCompatEnabled := groupFields[19].Descriptor()
	// group.DefaultBedrockRequestCompatEnabled holds the default value on creation for the bedrock_request_compat_enabled field.
	group.DefaultBedrockRequestCompatEnabled = groupDescBedrockRequestCompatEnabled.Default.(bool)
