...
func (e EnterpriseEdges) AccountsOrErr() ([]*Account, error) {
	if e.loadedTypes[0] {
...
func (*Enterprise) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case enterprise.FieldName, enterprise.FieldNotes, enterprise.FieldStatus:
...
// QueryAccounts queries the "accounts" edge of the Enterprise entity.
func (_m *Enterprise) QueryAccounts() *AccountQuery {
	return NewEnterpriseClient(_m.config).QueryAccounts(_m)
}
