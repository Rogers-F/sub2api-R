...
func (s *APIKeyService) snapshotFromAPIKey(apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ClaudePromptCachingEnabled:            apiKey.Group.ClaudePromptCachingEnabled,
			ThinkingSignatureCompatEnabled:        apiKey.Group.ThinkingSignatureCompatEnabled,
			BedrockThinkingSignatureCompatEnabled: apiKey.Group.BedrockThinkingSignatureCompatEnabled,
			ClaudeToolUseRepairEnabled:            apiKey.Group.ClaudeToolUseRepairEnabled,
			ClaudeToolArgumentsRepairEnabled:      apiKey.Group.ClaudeToolArgumentsRepairEnabled,
			StrongSafetyModeEnabled:               apiKey.Group.StrongSafetyModeEnabled,
			...
			ForceApplicationJSONForNonStream:      apiKey.Group.ForceApplicationJSONForNonStream,
		}
	}
	return snapshot
}
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ClaudePromptCachingEnabled:            snapshot.Group.ClaudePromptCachingEnabled,
			ThinkingSignatureCompatEnabled:        snapshot.Group.ThinkingSignatureCompatEnabled,
			BedrockThinkingSignatureCompatEnabled: snapshot.Group.BedrockThinkingSignatureCompatEnabled,
			ClaudeToolUseRepairEnabled:            snapshot.Group.ClaudeToolUseRepairEnabled,
			ClaudeToolArgumentsRepairEnabled:      snapshot.Group.ClaudeToolArgumentsRepairEnabled,
			StrongSafetyModeEnabled:               snapshot.Group.StrongSafetyModeEnabled,
			...
			ForceApplicationJSONForNonStream:      snapshot.Group.ForceApplicationJSONForNonStream,
		}
	}
