	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldBedrockThinkingSignatureCompatEnabled,
				group.FieldClaudeToolUseRepairEnabled,
				group.FieldClaudeToolArgumentsRepairEnabled,
				group.FieldStrongSafetyModeEnabled,
				...
				group.FieldForceApplicationJSONForNonStream,
			)
		}).
		Only(ctx)
	if err != nil {
