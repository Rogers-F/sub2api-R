...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authService := service.ProvideAuthServiceWithReferral(userRepository, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, referralService)
	...
	announcementRepository := repository.NewAnnouncementRepository(client, db)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, referralHandler, handlerAnnouncementHandler)
