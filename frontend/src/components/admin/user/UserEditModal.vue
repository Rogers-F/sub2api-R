  ...
  >
    <form v-if="user" id="edit-user-form" @submit.prevent="handleUpdateUser" class="space-y-5">
      ...
      <div>
        ...
        <div class="flex gap-2">
          <div class="relative flex-1">
            ...
            <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1 transition-colors hover:bg-paper-100 dark:hover:bg-white/[0.04]" :class="passwordCopied ? 'text-green-500' : 'text-dust-400'">
      ...
      <div>
        ...
        <p class="mt-1 text-xs text-dust-500 dark:text-pearl-300">{{ t('admin.users.soraStorageQuotaHint') }}</p>
      </div>
