    ...
    >
      <form id="create-group-form" @submit.prevent="handleCreateGroup" class="space-y-5">
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t('admin.groups.promptCaching.title') }}
            </label>
            <div class="group relative inline-flex">
              <Icon
                name="questionCircle"
              ...
              <div class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-72 opacity-0 transition-all duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
                <div class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-gray-800">
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t('admin.groups.promptCaching.tooltip') }}
                  </p>
                  <div class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"></div>
                </div>
              </div>
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="createForm.claude_prompt_caching_enabled = !createForm.claude_prompt_caching_enabled"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                createForm.claude_prompt_caching_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  createForm.claude_prompt_caching_enabled ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ createForm.claude_prompt_caching_enabled ? t('admin.groups.promptCaching.enabled') : t('admin.groups.promptCaching.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.promptCaching.hint') }}
          </p>
        </div>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t('admin.groups.unrequested1hAs5m.title') }}
            </label>
            <div class="group relative inline-flex">
              <Icon
                name="questionCircle"
              ...
              <div class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-72 opacity-0 transition-all duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
                <div class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-gray-800">
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t('admin.groups.unrequested1hAs5m.tooltip') }}
                  </p>
                  <div class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"></div>
                </div>
              </div>
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="createForm.claude_unrequested_1h_cache_as_5m = !createForm.claude_unrequested_1h_cache_as_5m"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                createForm.claude_unrequested_1h_cache_as_5m ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  createForm.claude_unrequested_1h_cache_as_5m ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ createForm.claude_unrequested_1h_cache_as_5m ? t('admin.groups.unrequested1hAs5m.enabled') : t('admin.groups.unrequested1hAs5m.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.unrequested1hAs5m.hint') }}
          </p>
        </div>
        ...
        <div v-if="['anthropic', 'antigravity'].includes(createForm.platform)" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t('admin.groups.thinkingSignatureCompat.title') }}
            </label>
            <div class="group relative inline-flex">
              <Icon
                name="questionCircle"
              ...
              <div class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-80 opacity-0 transition-all duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
                <div class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-gray-800">
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t('admin.groups.thinkingSignatureCompat.tooltip') }}
                  </p>
                  <div class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"></div>
                </div>
              </div>
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="createForm.thinking_signature_compat_enabled = !createForm.thinking_signature_compat_enabled"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                createForm.thinking_signature_compat_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  createForm.thinking_signature_compat_enabled ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ createForm.thinking_signature_compat_enabled ? t('admin.groups.thinkingSignatureCompat.enabled') : t('admin.groups.thinkingSignatureCompat.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.thinkingSignatureCompat.hint') }}
          </p>
        </div>
        ...
        <div v-if="['anthropic', 'antigravity'].includes(createForm.platform)" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
              {{ t('admin.groups.claudeToolUseRepair.title') }}
            </label>
            <div class="group relative inline-flex">
              <Icon
                name="questionCircle"
              ...
              <div class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-80 opacity-0 transition-all duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
                <div class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-gray-800">
                  <p class="text-xs leading-relaxed text-gray-300">
                    {{ t('admin.groups.claudeToolUseRepair.tooltip') }}
                  </p>
                  <div class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"></div>
                </div>
              </div>
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="createForm.claude_tool_use_repair_enabled = !createForm.claude_tool_use_repair_enabled"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                createForm.claude_tool_use_repair_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  createForm.claude_tool_use_repair_enabled ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ createForm.claude_tool_use_repair_enabled ? t('admin.groups.claudeToolUseRepair.enabled') : t('admin.groups.claudeToolUseRepair.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.claudeToolUseRepair.hint') }}
          </p>

          <div class="mt-4">
            <div class="mb-1.5 flex items-center gap-1">
              <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.groups.claudeToolArgumentsRepair.title') }}
              </label>
              <div class="group relative inline-flex">
                <Icon
                  name="questionCircle"
                ...
                <div class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-80 opacity-0 transition-all duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
                  <div class="rounded-lg bg-gray-900 p-3 text-white shadow-lg dark:bg-gray-800">
                    <p class="text-xs leading-relaxed text-gray-300">
                      {{ t('admin.groups.claudeToolArgumentsRepair.tooltip') }}
                    </p>
                    <div class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-gray-900 dark:bg-gray-800"></div>
                  </div>
                </div>
            ...
            <div class="flex items-center gap-3">
              <button
                type="button"
                @click="createForm.claude_tool_arguments_repair_enabled = !createForm.claude_tool_arguments_repair_enabled"
                :class="[
                  'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                  createForm.claude_tool_arguments_repair_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
                ]"
              >
                <span
                  :class="[
                    'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                    createForm.claude_tool_arguments_repair_enabled ? 'translate-x-6' : 'translate-x-1'
                  ]"
                />
              </button>
              <span class="text-sm text-gray-500 dark:text-gray-400">
                {{ createForm.claude_tool_arguments_repair_enabled ? t('admin.groups.claudeToolArgumentsRepair.enabled') : t('admin.groups.claudeToolArgumentsRepair.disabled') }}
              </span>
            </div>
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.groups.claudeToolArgumentsRepair.hint') }}
            </p>
          </div>
        </div>
        ...
        <div v-if="['openai', 'antigravity', 'anthropic', 'gemini'].includes(createForm.platform)" class="border-t border-gray-200 dark:border-dark-400 pt-4 mt-4 space-y-4">
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
              :class="createForm.require_oauth_only ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'"
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="createForm.require_oauth_only ? 'translate-x-6' : 'translate-x-1'"
              />
            </button>
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
              :class="createForm.require_privacy_set ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'"
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="createForm.require_privacy_set ? 'translate-x-6' : 'translate-x-1'"
              />
            </button>
          </div>
        </div>
      ...
      >
        ...
        <div v-if="editForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="editForm.claude_prompt_caching_enabled = !editForm.claude_prompt_caching_enabled"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                editForm.claude_prompt_caching_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  editForm.claude_prompt_caching_enabled ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ editForm.claude_prompt_caching_enabled ? t('admin.groups.promptCaching.enabled') : t('admin.groups.promptCaching.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.promptCaching.hint') }}
        ...
        <div v-if="editForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="editForm.claude_unrequested_1h_cache_as_5m = !editForm.claude_unrequested_1h_cache_as_5m"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                editForm.claude_unrequested_1h_cache_as_5m ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  editForm.claude_unrequested_1h_cache_as_5m ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ editForm.claude_unrequested_1h_cache_as_5m ? t('admin.groups.unrequested1hAs5m.enabled') : t('admin.groups.unrequested1hAs5m.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.unrequested1hAs5m.hint') }}
        ...
        <div v-if="['anthropic', 'antigravity'].includes(editForm.platform)" class="border-t pt-4">
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="editForm.thinking_signature_compat_enabled = !editForm.thinking_signature_compat_enabled"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                editForm.thinking_signature_compat_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  editForm.thinking_signature_compat_enabled ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ editForm.thinking_signature_compat_enabled ? t('admin.groups.thinkingSignatureCompat.enabled') : t('admin.groups.thinkingSignatureCompat.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.thinkingSignatureCompat.hint') }}
        ...
        <div v-if="['anthropic', 'antigravity'].includes(editForm.platform)" class="border-t pt-4">
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              @click="editForm.claude_tool_use_repair_enabled = !editForm.claude_tool_use_repair_enabled"
              :class="[
                'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                editForm.claude_tool_use_repair_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
              ]"
            >
              <span
                :class="[
                  'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                  editForm.claude_tool_use_repair_enabled ? 'translate-x-6' : 'translate-x-1'
                ]"
              />
            </button>
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ editForm.claude_tool_use_repair_enabled ? t('admin.groups.claudeToolUseRepair.enabled') : t('admin.groups.claudeToolUseRepair.disabled') }}
            </span>
          </div>
          <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
            {{ t('admin.groups.claudeToolUseRepair.hint') }}
          ...
          <div class="mt-4">
            ...
            <div class="flex items-center gap-3">
              <button
                type="button"
                @click="editForm.claude_tool_arguments_repair_enabled = !editForm.claude_tool_arguments_repair_enabled"
                :class="[
                  'relative inline-flex h-6 w-11 items-center rounded-full transition-colors',
                  editForm.claude_tool_arguments_repair_enabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'
                ]"
              >
                <span
                  :class="[
                    'inline-block h-4 w-4 transform rounded-full bg-white shadow transition-transform',
                    editForm.claude_tool_arguments_repair_enabled ? 'translate-x-6' : 'translate-x-1'
                  ]"
                />
              </button>
              <span class="text-sm text-gray-500 dark:text-gray-400">
                {{ editForm.claude_tool_arguments_repair_enabled ? t('admin.groups.claudeToolArgumentsRepair.enabled') : t('admin.groups.claudeToolArgumentsRepair.disabled') }}
              </span>
            </div>
            <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.groups.claudeToolArgumentsRepair.hint') }}
        ...
        <div v-if="['openai', 'antigravity', 'anthropic', 'gemini'].includes(editForm.platform)" class="border-t border-gray-200 dark:border-dark-400 pt-4 mt-4 space-y-4">
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
              :class="editForm.require_oauth_only ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'"
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="editForm.require_oauth_only ? 'translate-x-6' : 'translate-x-1'"
              />
            </button>
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
              :class="editForm.require_privacy_set ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-600'"
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="editForm.require_privacy_set ? 'translate-x-6' : 'translate-x-1'"
              />
            </button>
          </div>
        </div>
...
const createForm = reactive({
  ...
  claude_unrequested_1h_cache_as_5m: false,
...
const closeCreateModal = () => {
  ...
  createForm.claude_unrequested_1h_cache_as_5m = false
...
const handleEdit = (group: AdminGroup) => {
  ...
  editForm.claude_unrequested_1h_cache_as_5m = group.claude_unrequested_1h_cache_as_5m ?? false
