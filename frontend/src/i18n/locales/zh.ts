export default {
  ...
  profile: {
    ...
    balanceNotify: {
      title: '余额提醒',
      description: '当余额低于阈值时，通过额外通知邮箱接收提醒。',
      enabled: '启用余额提醒',
      threshold: '提醒阈值',
      thresholdHint: '低于该余额时触发提醒',
      thresholdPlaceholder: '输入自定义阈值',
      systemDefault: '系统默认',
      extraEmails: '通知邮箱',
      extraEmailsHint: '最多添加 3 个通知邮箱，新增邮箱需要先完成验证码验证。',
      emailPlaceholder: '输入通知邮箱',
      codePlaceholder: '6 位验证码',
      pendingHint: '验证码已发送，请输入后完成绑定。',
      sendCode: '发送验证码',
      resend: '重新发送',
      verify: '验证',
      verified: '已验证',
      unverified: '待验证',
      codeSent: '验证码已发送',
      verifySuccess: '通知邮箱已添加',
      verifyFailed: '验证码错误或已过期',
      removeEmail: '删除',
      removeSuccess: '通知邮箱已删除',
      invalidEmail: '请输入有效的邮箱地址',
      duplicateEmail: '该邮箱已在通知列表中',
      maxEmailsReached: '已达到最多 3 个通知邮箱的上限'
    }
  },
  ...
  admin: {
    ...
    accounts: {
      ...
      anthropic: {
        ...
        webSearchEmulationDesc: '当全局功能已启用时，覆盖当前 Anthropic API Key 账号是否启用 Web Search 模拟。',
        webSearchDefault: '默认',
        webSearchEnabled: '启用',
    ...
    enterprises: {
      title: '企业管理',
      description: '管理企业及其账号归属',
      detailTitle: '企业详情',
      detailDescription: '管理企业下的账号',
      search: '搜索企业...',
      create: '创建企业',
      edit: '编辑企业',
      delete: '删除企业',
      deleteConfirm: "确定要删除企业 '{name}' 吗？关联账号会自动变为无企业。",
      notes: '备注',
      status: '状态',
      statusActive: '启用',
      statusDisabled: '禁用',
      ...
      moveOut: '移出企业',
      allAccounts: '全部账号',
      moveSelectedIn: '移入选中 {count} 个账号',
      movedIn: '账号已移入',
      movedOut: '账号已移出',
      loadFailed: '加载企业失败',
      accountsLoadFailed: '加载企业账号失败',
      created: '企业已创建',
      updated: '企业已更新',
      deleted: '企业已删除',
      saveFailed: '保存企业失败',
    ...
    settings: {
      ...
      webSearchEmulation: {
        ...
        enabledHint: '全局开关。关闭后所有渠道和账号的 web search 模拟配置均不生效。',
        providers: '搜索服务商',
        addProvider: '添加服务商',
        apiKey: 'API Key',
      ...
      payment: {
        title: '支付设置',
        description: '配置支付系统相关选项',
        configGuide: '配置指南',
        enabled: '启用支付系统',
        enabledHint: '开启或关闭支付系统',
        enabledPaymentTypes: '启用的服务商类型',
        enabledPaymentTypesHint: '禁用某个服务商类型时，也会禁用对应实例。',
        findProvider: '在找合适的易支付上游？',
        minAmount: '最低金额',
        maxAmount: '最高金额',
        dailyLimit: '每日限额',
      ...
      balanceNotify: {
        title: '用户余额提醒',
        description: '配置用户余额不足时的全局提醒策略。',
        enabled: '启用余额提醒',
        threshold: '默认提醒阈值',
        thresholdHint: '当用户未自定义阈值时，使用该默认值。',
        rechargeUrl: '充值链接',
        rechargeUrlHint: '提醒邮件中的充值入口，留空时默认使用当前站点地址。'
      },
      quotaNotify: {
        title: '账号配额提醒',
        description: '当账号日/周/总额度触发阈值时，向管理员通知邮箱发送告警。',
        enabled: '启用账号配额提醒',
        emails: '通知邮箱列表',
        emailsHint: '建议填写管理员邮箱，支持多个地址。',
