export default {
  ...
  profile: {
    ...
    balanceNotify: {
      ...
      description: 'Receive low-balance alerts through additional notification email addresses.',
      enabled: 'Enable Balance Alerts',
      threshold: 'Alert Threshold',
      thresholdHint: 'Send an alert when balance falls below this amount',
      thresholdPlaceholder: 'Enter a custom threshold',
      systemDefault: 'System Default',
      extraEmails: 'Notification Emails',
      extraEmailsHint: 'You can add up to 3 emails. New emails must be verified first.',
      emailPlaceholder: 'Enter a notification email',
      codePlaceholder: '6-digit code',
      pendingHint: 'A verification code has been sent. Enter it to finish binding this email.',
      sendCode: 'Send Code',
      resend: 'Resend',
      verify: 'Verify',
      verified: 'Verified',
      ...
      verifySuccess: 'Notification email added',
      verifyFailed: 'Invalid or expired verification code',
      removeEmail: 'Remove',
      removeSuccess: 'Notification email removed',
      invalidEmail: 'Please enter a valid email address',
      duplicateEmail: 'This email is already in the notification list',
      maxEmailsReached: 'You have reached the maximum of 3 notification emails'
    }
  },
  ...
  admin: {
    ...
    accounts: {
      ...
      anthropic: {
        ...
        webSearchEmulationDesc:
          'When the global feature is enabled, override whether this Anthropic API Key account should emulate web search.',
    ...
    enterprises: {
      ...
      description: 'Manage enterprises and account ownership',
      detailTitle: 'Enterprise Detail',
      detailDescription: 'Manage accounts assigned to this enterprise',
      search: 'Search enterprises...',
      create: 'Create Enterprise',
      edit: 'Edit Enterprise',
      delete: 'Delete Enterprise',
      deleteConfirm: "Delete enterprise '{name}'? Linked accounts will become unassigned.",
      notes: 'Notes',
      status: 'Status',
      statusActive: 'Active',
      ...
      moveIn: 'Move Accounts In',
      moveOut: 'Move Out',
      allAccounts: 'All Accounts',
      moveSelectedIn: 'Move {count} Selected In',
      movedIn: 'Accounts moved in',
      movedOut: 'Accounts moved out',
      loadFailed: 'Failed to load enterprises',
      accountsLoadFailed: 'Failed to load enterprise accounts',
      created: 'Enterprise created',
      updated: 'Enterprise updated',
      deleted: 'Enterprise deleted',
      saveFailed: 'Failed to save enterprise',
      deleteFailed: 'Failed to delete enterprise',
    ...
    settings: {
      ...
      webSearchEmulation: {
        ...
        description: 'Inject web search capability for Anthropic API Key accounts that do not support it natively',
        enabled: 'Enable Web Search Emulation',
        enabledHint: 'Global switch. When disabled, all channel and account level web search emulation settings are ignored.',
        ...
        copied: 'Copied',
        quotaLimit: 'Quota Limit',
        quotaLimitHint: 'Leave empty for unlimited; when set it must be greater than 0',
        quotaLimitMustBePositive: 'Quota limit must be greater than 0',
        subscribedAt: 'Subscribed At',
        subscribedAtHint: 'Quota resets monthly from this date; leave empty to disable automatic reset',
        quotaUsage: 'Usage',
        resetUsage: 'Reset',
        resetUsageConfirm: 'Reset usage counters for this provider?',
        resetUsageSuccess: 'Usage reset successfully',
        proxy: 'Proxy',
        removeProvider: 'Remove',
        noProviders: 'No search providers configured',
        test: 'Test',
        testDefaultQuery: 'Search major world events this year',
        testing: 'Searching...',
        testResultTitle: 'Search Results',
        testResultProvider: 'Provider',
        testNoResults: 'No search results',
      },
      site: {
        title: 'Site Settings',
      ...
      balanceNotify: {
        title: 'User Balance Alerts',
        description: 'Configure the global low-balance alert policy for users.',
        enabled: 'Enable Balance Alerts',
        threshold: 'Default Alert Threshold',
        thresholdHint: 'Used when a user has not configured a custom threshold.',
        rechargeUrl: 'Recharge URL',
        rechargeUrlHint: 'Link included in the alert email. Defaults to the current site URL when left empty.'
      },
      quotaNotify: {
        title: 'Account Quota Alerts',
        description: 'Send alert emails to administrators when account daily, weekly, or total quota crosses the configured threshold.',
        enabled: 'Enable Account Quota Alerts',
        emails: 'Notification Emails',
        emailsHint: 'You can configure multiple administrator email addresses.',
