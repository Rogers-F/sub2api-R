export default {
  ...
  referral: {
    ...
    qrCodeTitle: 'Referral QR Code',
    qrCodeHint: 'Scan this QR code to visit the referral link',
  ...
  keys: {
    ...
    quotaLimit: 'Usage Quota',
    quotaPlaceholder: 'Enter quota limit',
    quotaHint: 'Maximum usage limit in USD. Requests will be rejected when the quota is exceeded.',
    quotaUsed: 'Quota',
